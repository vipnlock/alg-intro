...
import com.study.csdojo.Problem10_IsBinarySearchTree.TreeNode;
import org.junit.jupiter.api.Test;

import java.util.HashMap;

class Problem10_IsBinarySearchTreeTest {

    @Test
    void isBst() {
        Problem10_IsBinarySearchTree alg = new Problem10_IsBinarySearchTree();
        ...
        System.out.println(alg.isBst(head1) + " should return false");
        System.out.println(alg.isBst(head2) + " should return false");
        System.out.println(alg.isBst(head3) + " should return true");
        System.out.println(alg.isBst(head4) + " should return false");
    }
